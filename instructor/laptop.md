...
| **Device** | Laptop, desktop, or iPad with a browser (internet required) |
...
8. **Test the full workflow on the learners' device type** — create an account, make a repo, edit a file, enable Pages. Some school networks block GitHub or AI tools — find out before session day.

### Room setup

- Arrange tables in clusters of 4 so pairs can collaborate and share screens.
- Project your laptop screen for live demos.
...
1. **How websites work — the 30-second version** (5 min)
   ...
   - Show view-source on a simple webpage: right-click → "View Page Source" on your demo page. "See? It's just text with angle brackets. Not as scary as it looks."

   > 🖥️ **PROJECTOR:** Right-click your demo page → "View Page Source" to show raw HTML.

   **Instructor note:** Don't go deep on HTML/CSS here — just enough so they know what they're looking at later. The AI assistant will handle the actual code. The goal is "oh, that's all a website is?" not "oh no, I have to learn all of this."
...
- [ ] Laptops, desktops, or iPads (1 per learner, charged)
- [ ] Reliable Wi-Fi (test github.com and AI tool access beforehand)
